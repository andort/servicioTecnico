            ...
            <div class="col-lg-8">
                <ol class="breadcrumb">
                  ...
                  <li class="active">Gestion Servicios</li>
                   <li class="active">Solucion Garantías</li>
                </ol>
            </div>
        ...
        <div class="panel-heading">
            <div class="row">
                ...
                <input type="text" name="txtSede" style="display:none" value='<?php echo $_SESSION["sede"] ?>'>
                    <h5><span class="glyphicon glyphicon-user"></span>&nbsp;Solucion de Garantías</h5>
                </div>
            </div>
        </div>
              ...
              <table id="table_id" class="display" cellspacing="0" width="100%">
                <thead>
                  <tr>
                    ...
                    <th class="small" width="10%">Fecha</th>
                    <th class="small" width="18%">Cliente / Nit. o C.C.</th>
                    <th class="small" width="18%">Articulo(s)</th>
      ...
      <div class="modal-lg">
        <div class="modal-content">
          <div class="modal-header">
            <div class="row">
                <div class="col-lg-4">
                    <h5><span class="glyphicon glyphicon-th-large"></span>&nbsp;Solucion de Garantías</h5>
                </div>
                <div class="col-lg-4 text-right">
                    <h5>&nbsp;Orden Nro.</h5>
                </div>
          ...
          <div class="modal-body">
            ...
            <div class="row">
                <div class="col-lg-4">
                    ...
                    <div class="col-lg-12">
                    <input  type="email" class="form-control input-sm"name="txt_cliente" id="txt_cliente" readonly="readonly">
                    </div></div>
                </div>
                <div class="col-lg-4">
                    <div class="form-group">
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="form-group">
                    <div class="col-lg-12">
                    <textarea class="form-control input-sm" rows="4" id="txt_ccliente" style="resize:none;"></textarea>
                    </div></div>
                </div>
                ...
                <div class="col-lg-6">
                    <div class="form-group">
                    <div class="col-lg-12">
                    <textarea class="form-control input-sm" rows="4" id="txt_ctecnico" style="resize:none;"></textarea>
                    </div></div>
                </div>
            </div>
            ...
            <div class="panel-body"> <!--  Inicio BODY --> 
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8">
                        <div class="form-group">
                        <div class="col-lg-12">
                        <textarea class="form-control input-sm" rows="2" name="txtSolucion"  id="txtSolucion" placeholder="Comentario Solución..." style="resize:none;"></textarea>
                        </div></div>
                    </div>
                    <div class="col-lg-4">
                        <div class="form-group">
                        <div class="col-lg-12">
                        <select  type="text" class="form-control input-sm" placeholder="Seleccionar" name="txtRol" id="txtRol">
          ...
          <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="form-group">
                    <div class="col-lg-12">
                    <button type="submit" class="btn btn-success btn-sm btn-block" name="btnEnviar" id="btnEnv">Solucion Servicio</button>
                    </div></div>
                </div>
            </div>
