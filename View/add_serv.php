...
<div class="container">
        ...
        <div class="row fadeIn">
            <div class="col-lg-8">
                <ol class="breadcrumb">
                  ...
                  <li class="active">Ingresar Servicio</li>
                </ol>
            </div>
    ...
    <div class="panel-heading">
        <div class="row">
            <div class="col-lg-8">
                <h5><span class="glyphicon glyphicon-user"></span>&nbsp;Ingreso de Servicio</h5>
            </div>
            <div class="col-lg-4">
                <div class="form-group">
                <div class="col-lg-12 class_topborder">
                <select class="btn-block" name="txtServ" id="txtServ" onchange="mostrar_div()">
    ...
    <div class="panel-body"> <!--  Inicio BODY -->   
        ...
        <div class="row">
            <div class="col-lg-4">
                <div class="form-group">
                <div class="col-lg-12">
                <select class="btn-block" name="txtId" id="txtId" onchange="DatosClientes()">
                <option>Seleccione Nro. Identidad Cliente...</option>
        ...
        <div class="row">
            <div class="col-lg-4">
                <div class="form-group">
                <div class="col-lg-12">
                <input  type="email" class="form-control input-sm" placeholder="Movil y/o Telefono" name="txtDatoTel" id="txtDatoTel" readonly="readonly">
                </div></div>
            </div>
            <div class="col-lg-4">
                <div class="form-group">
        ...
        <div class="panel-body class_padding"> <!--  Inicio BODY -->
            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="form-group">
                    <div class="col-lg-12">
                    <input  type="text" class="form-control input-sm" maxlength="15" placeholder="Movil o Phone" name="txtMovil_otro" id="txtMovilgestor">
                    </div></div>
                </div>
            </div>
    ...
    <div class="panel-body class_padding"> <!--  Inicio BODY -->      
        ...
        <!-- INICIO SERVICIO TECNICO servicio -->
        <div class="row" id="servicio" hidden="">
            <div class="col-lg-6">
                <div class="form-group">
                <div class="col-lg-12">
                <textarea class="form-control input-sm" rows="4" placeholder="Observaciones del Cliente" id="txtObserv_cliente" name="txtObserv_cliente" style="resize:none;"></textarea>
                </div></div>
            </div>
            <div class="col-lg-6">
                <div class="form-group">
                <div class="col-lg-12">
                <textarea class="form-control input-sm" rows="4" placeholder="Descripcion Articulo" id="txtObserv_tecnico" name="txtObserv_tecnico" style="resize:none;"></textarea>
                </div></div>
            </div>
        </div>  
     </div> 
