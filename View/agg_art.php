...
<div class="container">
        ...
        <div class="row fadeIn">
            <div class="col-lg-8">
                <ol class="breadcrumb"> 
                  ...
                  <li class="active">Gestor Artículos</li>
                </ol>
            </div>
    ...
    <div class="panel-heading small">
        <div class="row small">
            ...
            <h5><span class="glyphicon glyphicon-cog"></span>&nbsp;Artículos</h5>
            </div></div>
        </div>
    </div>
    <div class="panel-body"> <!--  Inicio BODY -->   
            ...
            <div class="row">
                ...
                <div class="panel-body">
                    ...
                    <input type="text" class="form-control input-sm" name="txtName" parsley-required="true" placeholder="Nombre De Artículo" value='<?php echo $txtName1 ?>'>
                    </div></div>
                ...
                <div class="panel panel-info">
                <div class="panel-body">               
                    <table id="table_3" class="display" cellspacing="0" width="100%">
                    <thead>
                      <tr>
...
<!-- DataTables -->
    ...
    //             text: 'alerta de inicio cuando cargo',
    //             type: 'success',
    //             shadow: false
    // });
