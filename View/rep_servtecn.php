            ...
            <div class="col-lg-8">
                <ol class="breadcrumb">
                  ...
                  <li><a href="#">Gestion Servicios</a></li>
                   <li class="active">Reporte Servicios - Sede o Cliente</li>
                </ol>
            </div>
                ...
                <div class="col-lg-8">
                    ...
                    <div class="panel-body class_padding">
                        ...
                        <div class="form-group">
                            <select type="text" class="btn-block" name="txtBuscar" id="txtBuscar" parsley-required="true">
                            <option value="">Seleccione Busqueda...</option>
                            <option value="Carrusel del Exito">Sede Carrusel del Exito</option>
                            <option value="Monterrey">Sede Monterrey</option>
                            <option value="San Jose">Sede San Jose</option>
        ...
        <div class="modal-content">
          <div class="modal-body">
            ...
            <div class="panel-heading small">
                ...
                <div class="col-lg-4">
                	<div class="form-group">
                    <input  type="text" class="form-control input-sm" name="txt_estado" id="txt_estado" style="display:none">
            ...
            <div class="panel-body"> <!--  Inicio BODY --> 
                ...
                <div class="row">
                    ...
                    <div class="form-group">
                    <textarea class="form-control input-sm" rows="4" maxlength="500" name="txtSolucion"  id="txtSolucion" placeholder="Comentario Solución..." style="resize:none;" parsley-required="true"></textarea>
                    </div>
                    
                    <div class="form-group">
                    <select  type="text" class="form-control input-sm" placeholder="Seleccionar" name="txtEstado" id="txtEstado" parsley-required="true">
...
<!-- Scripts necesarios para la segunda libreria de datepicker -->
    ...
    function llevar_datos_modal(id, fecha, cliente, tel, estado, coment1, coment2){
        $("#txt_id").val(id);
        $("#txt_fecha").val(fecha);
