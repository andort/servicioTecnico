...
$name_cliente =  $_POST['c_name'];
$email =  $_POST['c_email'];
$direc_cliente =  $_POST['c_direc'];
$tel_cliente =  $_POST['c_tel'];
$c_cliente =  $_POST['c_cliente'];
$c_tecnico =  $_POST['c_tecnico'];
			...
			<table width="900" height="100" align="center" class="border_bot">
				<tr>
					...
					<span class="font_small3">
						...
						Nro. Servicio<br>
						<span class="font_small4"><b>'.$nro_servicio.'</b></span>
					</span>
					</td>
				</tr>
			</table>
