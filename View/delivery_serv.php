...
<div class="container">
            ...
            <div class="col-lg-8">
                <ol class="breadcrumb">
                  ...
                  <li class="active">Gestion Servicios</li>
                   <li class="active">Entrega Servicios</li>
                </ol>
            </div>
    ...
    <div class="panel panel-info">
        <div class="panel-heading">
            <div class="row">
                <div class="col-lg-8">
                    <h5><span class="glyphicon glyphicon-share"></span>&nbsp;&nbsp;&nbsp;Entrega de Servicios</h5>
                </div>
            </div>
        </div>
        ...
        <div class="modal-content">
          <div class="modal-body">
            ...
            <div class="col-lg-8">
                ...
                <div class="form-group">
                <textarea class="form-control input-sm" rows="4" id="txt_ccliente" readonly="readonly" style="resize:none;"></textarea>
                </div>
                
                <div class="form-group">
                <textarea class="form-control input-sm" rows="4" id="txt_ctecnico" readonly="readonly" style="resize:none;"></textarea>
                </div>
                
                <div class="form-group">
                <textarea class="form-control input-sm" rows="4" id="txt_solucion" readonly="readonly" style="resize:none;"></textarea>
                </div>
            ...
            <div class="col-lg-4">                 
                ...
                <div class="form-group">
                <br><span>Si el servicio es Recogido por otra Persona Distinda llene los siguientes datos</span>
                </div>
...
<!-- Scripts necesarios para la segunda libreria de datepicker -->
    ...
    function llevar_datos_modal(id, fecha, cliente, tel, coment1, coment2, coment3){
        $("#txt_id").val(id);
        $("#txt_fecha").val(fecha);
