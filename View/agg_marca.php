...
<div class="container">
    ...
    <div class="panel-heading small">
        <div class="row small">
            ...
            <h5><span class="glyphicon glyphicon-cog"></span>&nbsp;Marcas</h5>
            </div></div>
        </div>
    </div>
    <div class="panel-body"> <!--  Inicio BODY -->   
            ...
            <div class="row">
                ...
                <div class="panel-body">
                    ...
                    <input type="text" class="form-control input-sm" name="txtName" parsley-required="true" placeholder="Ingrese Marca" value='<?php echo $txtName1 ?>'>
                    </div></div>
                ...
                <div class="panel-body">               
                    ...
                    <thead>
                      <tr>
                        <th class="small">Nombre Marca</th>
