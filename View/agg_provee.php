    ...
    <div class="panel-body"> <!--  Inicio BODY -->   
        ...
        <div class="row">
            <div class="col-lg-4">
                ...
                <div class="col-lg-12">
                <input  type="text" class="form-control input-sm" placeholder="Codigo" parsley-required="true" name="txtCod" id="txtCod" value='<?php echo $txtCod1 ?>'>
                </div></div>
            </div>
            <div class="col-lg-4">
                <div class="form-group">
                <div class="col-lg-12">
                <input  type="text" class="form-control input-sm" placeholder="Nit" name="txtNit" parsley-required="true" value='<?php echo $txtNit1 ?>'>
                </div></div>
            </div>
            <div class="col-lg-4">
                <div class="form-group">
                <div class="col-lg-12">
                <input  type="text" class="form-control input-sm" placeholder="Nombre Empresa" name="txtName" parsley-required="true" value='<?php echo $txtName1 ?>'>
                </div></div>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-4">
                <div class="form-group">
                <div class="col-lg-12">
                <input  type="text" class="form-control input-sm" placeholder="Movil" name="txtMovil"  parsley-required="true" value='<?php echo $txtMovil1 ?>'>
                </div></div>
            </div>
            <div class="col-lg-4">
                <div class="form-group">
        ...
        <div class="row">
            <div class="col-lg-4">
                <div class="form-group">
                <div class="col-lg-12">
                <input  type="text" class="form-control input-sm" placeholder="Nombre Contácto 1" name="txtN1" parsley-required="true" value='<?php echo $txtN11 ?>'>
                </div></div>
            </div>
            <div class="col-lg-4">
                <div class="form-group">
                <div class="col-lg-12">
                <input  type="text" class="form-control input-sm" placeholder="Nombre Contácto 2" name="txtN2" parsley-required="true" value='<?php echo $txtN21 ?>'>
                </div></div>
            </div>
            <div class="col-lg-4">
                <div class="form-group">
                <div class="col-lg-12">
                <input  type="text" class="form-control input-sm" placeholder="Ciudad" name="txtCiudad" parsley-required="true" value='<?php echo $txtCiudad1 ?>'>
                </div></div>
            </div>
