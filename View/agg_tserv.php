...
<div class="container">
        ...
        <div class="row fadeIn">
            <div class="col-lg-8">
                <ol class="breadcrumb"> 
                  ...
                  <li class="active">CRUD Servicios</li>
                </ol>
            </div>
    ...
    <div class="panel-heading small">
        <div class="row small">
            ...
            <h5><span class="glyphicon glyphicon-cog"></span>&nbsp;Tipo de Servicios</h5>
            </div></div>
        </div>
    </div>
    <div class="panel-body"> <!--  Inicio BODY -->   
            ...
            <div class="row">
                ...
                <div class="panel-body">
                    ...
                    <input type="text" class="form-control input-sm" name="txtName" placeholder="Nombre Servicio" parsley-required="true" value='<?php echo $txtName1 ?>'>
                    </div></div>
