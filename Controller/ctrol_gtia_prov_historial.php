<?php 
	...
	// Busco el articulo seleccionado para cambiarle el estado siempre y cuando el proveedor 
	// lo haya pagado, rechazado o dado nota credito
	if (isset($_POST['btnEnviar'])){	

		$serv =	tb_articulo::find('last',array('conditions' => array('id_articulo = ?',$_POST['txt_id'])));

		$serv->estado = $_POST['txtStatus'];
		$serv->fecha_pago_prov = $fecha;

		$serv->save();
		echo "<script>	alert('Se Modificó el ARTÍCULO con éxito'); </script>";
	}
